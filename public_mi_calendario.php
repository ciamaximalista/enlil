...
if (!$entry || $entry['type'] !== 'mi_calendario') {
...
function enlil_month_matrix_public(int $baseDate): array {
...
function enlil_week_days_public(int $baseDate): array {
...
function enlil_format_month_es_public(int $ts): string {
    $months = [
...
enlil_page_header('Mi calendario', false);
?>
    <main class="container">
        ...
        <div class="section-card calendar-card">
            <div class="calendar-header">
                <strong><?php echo htmlspecialchars(enlil_format_month_es_public($baseDate)); ?></strong>
                <div class="actions">
                    <?php if ($view === 'month'): ?>
                        <?php if ($canPrevMonth): ?>
            ...
            <?php if ($view === 'month'): ?>
                <div class="calendar-grid">
                    ...
                    <?php foreach (enlil_month_matrix_public($baseDate) as $row): ?>
            ...
            <?php else: ?>
                <div class="calendar-grid week">
                    <?php foreach (enlil_week_days_public($baseDate) as $dayTs): ?>
                        <?php $dayKey = date('Y-m-d', $dayTs); ?>
